    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-brand">
          <img src={logo} alt="ConsultME Logo" className="footer-logo" />

          <p className="brand-text">
            ConsultMe: Your partner in smart, AI-powered business consulting.
            Accelerate your growth with innovation-driven solutions.
          </p>
        ...
        <div className="footer-column">
          ...
          <ul>
            <li>
              <Link to="/freelancer">Become a Freelancer</Link>
            </li>
            <li>
